...
impl LanguageServer for Backend {
    ...
    {
        self.files.insert(params.text_document.uri, params.text_document.text.into());
    }

    async fn did_change(&self, params: DidChangeTextDocumentParams)
    {
        self.files.insert(params.text_document.uri, Rope::from_str(&params.content_changes[0].text));
    }
