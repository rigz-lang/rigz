pub mod runtime {
    ...
    pub mod valid {
        ...
        run_expected! {
            ...
            mutable_references_bin_assign("mut a = 4; mut b = a; b += 2; assert_eq a, b" = ())
            mutable_references_overwrite("mut a = 4; mut b = a; b = 2; assert_eq a, b" = ())
            mutable_references_scoped_overwrite("mut a = 4; b = do\n  a = 2\nend; b; assert_eq a, 2" = ())
