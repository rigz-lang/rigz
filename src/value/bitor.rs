...
mod tests {
    ...
    define_value_tests! {
        | {
            ...
            test_false_0_bitor_true => (Value::Bool(false), Value::Number(Number::zero()), Value::Bool(false));
            test_true_0_bitor_true => (Value::Bool(true), Value::Number(Number::zero()), Value::Number(Number::one()));
